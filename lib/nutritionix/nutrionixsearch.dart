...
typedef OnItemSelected = void Function(String name, double calories, double cholesterol);
                ...
                builder: (context) => AlertDialog(
                  ...
                  actions: <Widget>[
                    TextButton(
                      child: Text('Add'),
                      onPressed: () {
                        widget.onItemSelected(food['food_name'], details.calories, details.cholesterol);
