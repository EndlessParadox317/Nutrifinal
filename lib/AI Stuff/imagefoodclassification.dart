...
class FoodClassification {
  ...
  Future<Map<String, dynamic>> classifyImageFromSource(XFile image) async {
    ...
    return await _runModelOnImage(imageBytes);
  }

  Future<Map<String, dynamic>> _runModelOnImage(Uint8List imageBytes) async {
    try {
      ...
      if (maxValue > 25) {
        ...
        return {'label': predictedLabel, 'calories': predictedCalories, 'confidence': maxValue.toStringAsFixed(2)};
      } else {
